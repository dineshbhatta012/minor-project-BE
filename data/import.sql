...
-- fare_rules
\copy fare_rules (fare_id, min_distance_km, max_distance_km, fare_npr_min, fare_npr_max, student_discount_pct, verification_note) FROM '/path/to/csv/fare_rules_clean.csv' WITH (FORMAT csv, HEADER true, NULL '')
